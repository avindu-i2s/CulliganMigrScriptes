...
/*
	...
	20230808	REV E	BN	Update to Service Functional Object ID to include the ServTypeC as the prefix
							Created Master Table of Service Functional Object ID dbo.z_WF_FuncObj_Ser
...
DECLARE
@SITE_ VARCHAR(10) = '74015',
@MigSource_ varchar(50) =  '15 - Melbourne'
...
inner join dbo.WF_ML_ServiceCodes sc on cs.service_c = sc.SERVICE_C
