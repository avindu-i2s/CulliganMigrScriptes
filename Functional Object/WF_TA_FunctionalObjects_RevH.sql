...
7.  RAIDD #254 -  '03 - Ocala Culligan' and '06 - West Palm Beach' does not use the Installed Date Field - Need Data
			Per Tobias on 8/9/2023 - Installed Date is not a required field
...
DECLARE
@SITE_ VARCHAR(10) = '74010',
@MigSource_ varchar(50) ='10 - Tallahassee'
...
inner join dbo.WF_TA_ServiceCodes sc on cs.service_c = sc.SERVICE_C
