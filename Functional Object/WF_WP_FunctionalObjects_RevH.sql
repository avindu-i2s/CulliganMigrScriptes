...
7.  RAIDD #254 -  '03 - Ocala Culligan' and '06 - West Palm Beach' does not use the Installed Date Field - Need Data
		--Per Tobias on 8/9/2023 - Install Date is not a required Field.  
...
DECLARE
@SITE_ VARCHAR(10) = '74006',
@MigSource_ varchar(50) = '06 - West Palm Beach'
...
,  CONVERT(date,ce.Installed_date,101) InstallationDate
...
inner join dbo.WF_WP_ServiceCodes sc on cs.service_c = sc.SERVICE_C
