...
, case  WHEN cs.service_rate  is null then ''
	...
	else cONCAT('11', '-',CS.ACCOUNT_NUMBER,'-',CS.SERVICE_NUMBER)
	end ContractID_SC
, 1 LineNo_PMSC
, 'DAY' StartUnit_PM
...
left join [dbo].[WF_ContractServiceTranslation] ST ON ST.BRANCH = '11 - Charleston, SC' AND CS.SERVICE_C = ST.service_code
